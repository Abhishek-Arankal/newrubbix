  ...
  },
  {
    ...
    return(
        <div id="services" className="w-full h-auto flex flex-col items-center justify-center lg:px-[80px] px-[20px] lg:py-[80px] py-[60px] gap-[20px] bg-[#DCE0E1]">
            <h1 className="text-black uppercase text-md ">Our Services</h1>
            <h1 className="text-black lg:text-[45px] text-[30px] capitalize leading-[1.2em] lg:w-[50%] w-full text-center ">Driving Digital Transformation with Excellence</h1>
            <p className="text-gray-500 text-md lg:w-[60%] w-full text-center">At Rubix IT, we offer IT, HR, and business solutions that help organizations streamline operations, boost productivity, and achieve their goals efficiently and ethically.</p>
